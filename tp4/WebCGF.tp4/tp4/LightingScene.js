...
// 	this.materialB.setShininess(120);
	...
	//this.lights[0].setSpecular(1,1,0); //Pure Yellow
	...
	this.slidesAppearance.setSpecular(0.2, 0.2, 0.2, 0);
	this.slidesAppearance.setAmbient(0.3,0.3,0.3,1);
	this.slidesAppearance.setShininess(40);
	this.slidesAppearance.setDiffuse(0.8, 0.8, 0.8, 1);

	this.boardAppearance =  new CGFappearance(this);
	this.boardAppearance.loadTexture("../resources/images/board.png");
	this.boardAppearance.setTextureWrap('CLAMP_TO_EDGE', 'CLAMP_TO_EDGE');
	this.boardAppearance.setSpecular(0.6, 0.6, 0.6, 0);
