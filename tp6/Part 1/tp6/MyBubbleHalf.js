 ...
 * @constructor
 */
 function MyBubbleHalf(scene, slices, stacks) {
 ...
 MyBubbleHalf.prototype = Object.create(CGFobject.prototype);
 MyBubbleHalf.prototype.constructor = MyBubbleHalf;

 MyBubbleHalf.prototype.initBuffers = function() {
